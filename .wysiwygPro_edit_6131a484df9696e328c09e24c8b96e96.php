...
<html>
<head>
<title>Editing site_map.html</title>
...
<form METHOD="POST" name=mform action="http://thequeensowncameronhighlandersofcanada.net:2082/frontend/x3/filemanager/savehtmlfile.html">
    ...
    <input type="hidden" name="baseurl" value="http://thequeensowncameronhighlandersofcanada.net/">
    <input type="hidden" name="basedir" value="/home/wxgkujqw/public_html/">
    <input type="hidden" name="udir" value="/home/wxgkujqw/public_html">
    <input type="hidden" name="ufile" value="site_map.html">
    <input type="hidden" name="dir" value="%2fhome%2fwxgkujqw%2fpublic_html">
    <input type="hidden" name="file" value="site_map.html">
...
$editor->baseURL = "http://thequeensowncameronhighlandersofcanada.net/";

$editor->loadValueFromFile('/home/wxgkujqw/public_html/site_map.html');
...
$editor->plugins['serverPreview']->URL = 'http://thequeensowncameronhighlandersofcanada.net/.wysiwygPro_preview_6131a484df9696e328c09e24c8b96e96.php?randomId=aXGUbFU_5HyKJAwBI7xZm9UjNC48VCA53uFkGPKNLwNQ18KTrDxGo8CTsF1WRRFn0bX9Rk2z2DwZTTz0klXUWDjAaRhcG5nwtbXseIH_SrbwpkUhVTL2p8y9RkCoUsvC7l2l2abnbLalw6uqszDIEZ5WxecCOjJzGZlR1NIRQKQREM5hzf4Qe1LswmpVidgCYojLAk1NACqDQ7DXcSeGb1lMwqImJ1hGkDVr9VwPZRnLH2ni0KAeN5pV3ubNDjBz';
