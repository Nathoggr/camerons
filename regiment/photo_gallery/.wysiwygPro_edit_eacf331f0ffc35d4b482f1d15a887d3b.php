<?php ob_start() ?>
<?php
if ($_GET['randomId'] != "Jz34fefYBAckgi7iRruDLKKIuZsjI50FpybDgNYLRiLLVLa_UtKJacsbm0w_34uzvJ4mLQ5wpZeaODNQpul8SiYUp8ncpaf5Kn20VrWF2Kle2bgqUsWhXS7O6jSfnkJj1QUid6kNDKfaIUuhbmF1ugjLznWRvYjp615QZdRURdgx2qL_AFIyMoiJfID6HDlgKjw5PynheN84KuhomhYndNGJITavvCdLVCSyq3SfvDUjbnKEtLe5y8_h63HhiRh3") {
    echo "Access Denied";
    exit();
}
?>
...
<form METHOD="POST" name=mform action="http://thequeensowncameronhighlandersofcanada.net:2082/frontend/x3/filemanager/savehtmlfile.html">
    ...
    <input type="hidden" name="baseurl" value="http://thequeensowncameronhighlandersofcanada.net/regiment/photo_gallery/">
    <input type="hidden" name="basedir" value="/home/wxgkujqw/public_html/">
    <input type="hidden" name="udir" value="/home/wxgkujqw/public_html/regiment/photo_gallery">
    <input type="hidden" name="ufile" value="index.html">
    <input type="hidden" name="dir" value="%2fhome%2fwxgkujqw%2fpublic_html%2fregiment%2fphoto_gallery">
...
$editor->baseURL = "http://thequeensowncameronhighlandersofcanada.net/regiment/photo_gallery/";

$editor->loadValueFromFile('/home/wxgkujqw/public_html/regiment/photo_gallery/index.html');
...
$editor->plugins['serverPreview']->URL = 'http://thequeensowncameronhighlandersofcanada.net/regiment/photo_gallery/.wysiwygPro_preview_eacf331f0ffc35d4b482f1d15a887d3b.php?randomId=Jz34fefYBAckgi7iRruDLKKIuZsjI50FpybDgNYLRiLLVLa_UtKJacsbm0w_34uzvJ4mLQ5wpZeaODNQpul8SiYUp8ncpaf5Kn20VrWF2Kle2bgqUsWhXS7O6jSfnkJj1QUid6kNDKfaIUuhbmF1ugjLznWRvYjp615QZdRURdgx2qL_AFIyMoiJfID6HDlgKjw5PynheN84KuhomhYndNGJITavvCdLVCSyq3SfvDUjbnKEtLe5y8_h63HhiRh3';
