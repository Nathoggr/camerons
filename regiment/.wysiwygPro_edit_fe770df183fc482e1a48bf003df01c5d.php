<?php ob_start() ?>
<?php
if ($_GET['randomId'] != "COBQxiy0HXyyUitzbz6PD0bw7hS2CTKdWrfD7mtsfpbesK0hgqiOCgv1bQgblcRvGcOGg9aN0YYxTcAHmUws2voPFN6juzEU0ZCoXABSAI5SUtod0TViTKb_SFmkXNZT8On8X0Fkofv8HECYxzoztlLxAp9pRNFEcWAJ7pXjUa7TEdPCvmBY_scDiPPfw1Ld7ynZp56qmblFcCYRl9veQm0GweL_ncxXGk7dT26TP5QYhLO_Ogx0VtDXCheOXy5G") {
    echo "Access Denied";
    exit();
}
?>
...
<html>
<head>
<title>Editing sergeants.html</title>
...
<form METHOD="POST" name=mform action="http://thequeensowncameronhighlandersofcanada.net:2082/frontend/x3/filemanager/savehtmlfile.html">
    ...
    <input type="hidden" name="ufile" value="sergeants.html">
    <input type="hidden" name="dir" value="%2fhome%2fwxgkujqw%2fpublic_html%2fregiment">
    <input type="hidden" name="file" value="sergeants.html">
...
$editor->loadValueFromFile('/home/wxgkujqw/public_html/regiment/sergeants.html');
...
$editor->plugins['serverPreview']->URL = 'http://thequeensowncameronhighlandersofcanada.net/regiment/.wysiwygPro_preview_fe770df183fc482e1a48bf003df01c5d.php?randomId=COBQxiy0HXyyUitzbz6PD0bw7hS2CTKdWrfD7mtsfpbesK0hgqiOCgv1bQgblcRvGcOGg9aN0YYxTcAHmUws2voPFN6juzEU0ZCoXABSAI5SUtod0TViTKb_SFmkXNZT8On8X0Fkofv8HECYxzoztlLxAp9pRNFEcWAJ7pXjUa7TEdPCvmBY_scDiPPfw1Ld7ynZp56qmblFcCYRl9veQm0GweL_ncxXGk7dT26TP5QYhLO_Ogx0VtDXCheOXy5G';
